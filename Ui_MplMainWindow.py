...
class Ui_MainWindow(QtGui.QMainWindow):
    def setupUi(self, MainWindow):
        ...
        self.widget.setGeometry(QtCore.QRect(10, 30, 621, 141))
        ...
        self.m_xzStartPos = QtGui.QPushButton(self.widget)
        self.m_xzStartPos.setObjectName(_fromUtf8("m_xzStartPos"))
        self.verticalLayout_10.addWidget(self.m_xzStartPos)
        self.m_xzEndPos = QtGui.QPushButton(self.widget)
        self.m_xzEndPos.setObjectName(_fromUtf8("m_xzEndPos"))
        self.verticalLayout_10.addWidget(self.m_xzEndPos)
        self.verticalLayout_9 = QtGui.QVBoxLayout()
        self.verticalLayout_9.setObjectName(_fromUtf8("verticalLayout_9"))
        self.m_yzStartPos = QtGui.QPushButton(self.widget)
        self.m_yzStartPos.setObjectName(_fromUtf8("m_yzStartPos"))
        self.verticalLayout_9.addWidget(self.m_yzStartPos)
        self.m_yzEndPos = QtGui.QPushButton(self.widget)
        self.m_yzEndPos.setObjectName(_fromUtf8("m_yzEndPos"))
        self.verticalLayout_9.addWidget(self.m_yzEndPos)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.m_yzStartPos.setText(_translate("MainWindow", "Y-Z扫查起点", None))
        self.m_yzEndPos.setText(_translate("MainWindow", "Y-Z扫查终点", None))
